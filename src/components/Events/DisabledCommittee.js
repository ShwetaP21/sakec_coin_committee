...
const DisbaledCommitte = () => {
    ...
    const handleEnable = async (e, id) => {
        ...
        await db.collection('committees').doc(id).update({
            ...
            .then(() => {
                toast.success('Committee Enabled Successfully');
                window.location.href = "/view-committees";
            }).catch((error) => {
                toast.error('Error Enabled Committee')
                console.error('Error Enabled document: ', error);
            });
    }
                    ...
                    <div className="layout-page">
                        ...
                        <div className="container-xxl flex-grow-1 container-p-y">
                            ...
                            <h4 className="fw-bold py-3 mb-4">
                                <span className="text-muted fw-light">{process.env.REACT_APP_NAME} /</span> Disabled Committees
                            </h4>
                                ...
                                {data.map((d) => (
                                    <tbody key={d.updated_at}>
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-success" onClick={(e) => handleEnable(e, d.email)}> Enable</button></td>
                                        </tr>
                                    </tbody>
                                ))
                                }
...
export default DisbaledCommitte
...
const Login = () => {
  ...
  const handleSubmit = async () => {
    try {
      await signIn(committee.webemail, committee.password);
          ...
          <div className="authentication-inner">
            ...
            <div className="card">
              <div className="card-body">
                ...
                {/* /Logo */}
                <h4 className="mb-2">Welcome to {process.env.REACT_APP_NAME}! 👋</h4>
                <p className="mb-4">
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    name="webemail"
                    defaultValue={committee.webemail}
                ...
                <div className="mb-3 form-password-toggle">
                  ...
                  <div className="input-group input-group-merge">
                    <input
                      ...
                      id="password"
                      onChange={handleChange}
                      defaultValue={committee.password}
                      className="form-control"
                      name="password"
                      placeholder="············"
